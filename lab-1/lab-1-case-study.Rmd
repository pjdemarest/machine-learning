...
In the overview presentation for this lab, we considered five
...
succeeding in it. In the ML Lab 1 case study will cover the
...
of description or explanation. We have two readings in Lab 1
...
[GitHub](https://github.com/DrItauma-NU), a Project has already been
...
already been installed and loaded into RStudio or RStudio Cloud by looking at
the Files, Plots, & Packages Pane in the lower right-hand corner.

Two packages we'll use extensively throughout these labs are
