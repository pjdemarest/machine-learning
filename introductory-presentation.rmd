...
- A small but important set of ideas --- predictions, interpretation. feature engineering, and supervised and unsupervised methods-- about machine learning
...
- LL 1: Prediction: How do predictive models differ from other models?
- LL 2: Interpretation: How do we interpret the accuracy of a prediction model?
- LL 3: Feature Engineering: How can we make our model better?
...
- *Dr. Mighty Itauma Itauma* (itaumai@northwood.edu; https://github.com/amightyo). 
